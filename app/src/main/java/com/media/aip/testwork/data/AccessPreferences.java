...
public final class AccessPreferences {
     ...
     * {@link #commit(android.content.Context, String, Object)}. When you call this method from
     ...
     * Set<String> before API 11 (HONEYCOMB). You **can** persist a {@link java.util.Set}
    ...
    /**
     * As {@link #put(android.content.Context, String, Object)} but will call
     * {@link android.content.SharedPreferences.Editor#commit()} in all API
     * versions. See {@link #put(android.content.Context, String, Object)} for detailed usage
     * notes.
     *
     * @param ctx   the context the Shared preferences belong to
     * @param key   the preference's key, must not be {@code null}
     ...
     * @param defaultValue
     * @return
     * @throws ClassCastException       If you try to get a different type than the one you put in -
     *                                  except if you specify a null default (***). For other CCEs
     *                                  see the {@link #put(android.content.Context, String, Object)} docs
    ...
    /**
     * Wraps
     * {@link android.content.SharedPreferences#registerOnSharedPreferenceChangeListener(android.content.SharedPreferences.OnSharedPreferenceChangeListener)}
     * .
     *
     * @param ctx the context the SharedPreferences belong to
    ...
    /**
     * Wraps
     * {@link android.content.SharedPreferences#unregisterOnSharedPreferenceChangeListener(android.content.SharedPreferences.OnSharedPreferenceChangeListener)}
     * .
     *
     * @param ctx the context the SharedPreferences belong to
     * @param lis the listener, must not be null
    ...
    /**
     * Wraps
     * {@link android.content.SharedPreferences.OnSharedPreferenceChangeListener#onSharedPreferenceChanged(android.content.SharedPreferences, String)}
     * .
     *
     * @param ctx the context the SharedPreferences belong to
     * @param lis the listener, must not be null
